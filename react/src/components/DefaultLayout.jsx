      ...
      <div className="min-h-full">
         <div className="flex flex-row">
          <div className="hidden md:block">
            ...
            <aside id="default-sidebar" className="top-0 left-0 z-40 w-60 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
              <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
                <div>
                  <a href="/painel" className="flex justify-left items-center space-x-3">
                    ...
                    <p className="text-2xl leading-6 text-white">PAINEL</p>
                  </a>
                </div>
                <div className="mt-10">
                  {navigation.map((item) => (
                      <NavLink
                        ...
                        className={({isActive}) => classNames(
                          ...
                          'flex justify-start items-center space-x-6 rounded px-3 py-2 w-52 mb-2 rounded-md px-3 py-2 text-sm font-medium'
                        )}
                      >
                        <span class="text-base leading-4">{item.name}</span>
                      </NavLink>
                    ))}
                  </div>
